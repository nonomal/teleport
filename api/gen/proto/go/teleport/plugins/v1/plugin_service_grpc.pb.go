...
type PluginServiceClient interface {
	...
	UpdatePluginStaticCredentials(ctx context.Context, in *UpdatePluginStaticCredentialsRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *pluginServiceClient) UpdatePluginStaticCredentials(ctx context.Context, in *UpdatePluginStaticCredentialsRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
type PluginServiceServer interface {
	...
	// UpdatePluginStaticCredentials
	UpdatePluginStaticCredentials(context.Context, *UpdatePluginStaticCredentialsRequest) (*emptypb.Empty, error)
	// NeedsCleanup will indicate whether a plugin of the given type needs cleanup
	// before it can be created.
...
func (UnimplementedPluginServiceServer) UpdatePluginStaticCredentials(context.Context, *UpdatePluginStaticCredentialsRequest) (*emptypb.Empty, error) {
